...
const SNOWFLAKES: SnowflakeData[] = [
  ...
  { src: IMAGES[1], width: '20%', left: '45%', duration: '35s', delay: '-15s', startRot: '15deg', endRot: '-5deg' },
  { src: IMAGES[2], width: '25%', left: '75%', duration: '30s', delay: '-8s', startRot: '5deg', endRot: '25deg' },
  { src: IMAGES[3], width: '24%', left: '20%', duration: '40s', delay: '-25s', startRot: '-20deg', endRot: '0deg' },
  { src: IMAGES[4], width: '28%', left: '60%', duration: '32s', delay: '-2s', startRot: '0deg', endRot: '-15deg' },
  ...
  { src: IMAGES[2], width: '26%', left: '5%', duration: '38s', delay: '-28s', startRot: '-15deg', endRot: '10deg' },
  { src: IMAGES[4], width: '25%', left: '80%', duration: '31s', delay: '-20s', startRot: '10deg', endRot: '-10deg' },
  ...
  { src: IMAGES[1], width: '22%', left: '15%', duration: '36s', delay: '-32s', startRot: '5deg', endRot: '-15deg' },
  { src: IMAGES[3], width: '23%', left: '70%', duration: '34s', delay: '-14s', startRot: '-10deg', endRot: '20deg' },
];
        ...
        {SNOWFLAKES.map((data, index) => (
          <div
            ...
            style={{
              ...
              '--end-rot': data.endRot,
              opacity: 0.12, // 微半透明
              filter: 'grayscale(100%) blur(1.5px)', // 灰階加上模糊，營造「看得見但看不清」的流動感
