...
const SNOWFLAKES: SnowflakeData[] = [
  ...
  // 媒體報導 (36% ~ 48%) -> 維持微弱背景感
  { src: IMAGES[5], width: '38%', left: '5%', duration: '36s', delay: '-12s', startRot: '-5deg', endRot: '15deg', opacity: 0.1 },
  { src: IMAGES[6], width: '40%', left: '35%', duration: '36s', delay: '-14s', startRot: '10deg', endRot: '-10deg', opacity: 0.1 },
  { src: IMAGES[7], width: '45%', left: '60%', duration: '36s', delay: '-16s', startRot: '-15deg', endRot: '5deg', opacity: 0.1 },
  { src: IMAGES[8], width: '36%', left: '45%', duration: '36s', delay: '-18s', startRot: '20deg', endRot: '-20deg', opacity: 0.1 },
  ...
  { src: IMAGES[5], width: '42%', left: '20%', duration: '36s', delay: '-26s', startRot: '-8deg', endRot: '12deg', opacity: 0.1 },
  { src: IMAGES[6], width: '36%', left: '65%', duration: '36s', delay: '-28s', startRot: '15deg', endRot: '-5deg', opacity: 0.1 },
  { src: IMAGES[7], width: '48%', left: '40%', duration: '36s', delay: '-30s', startRot: '-5deg', endRot: '-25deg', opacity: 0.1 },
  { src: IMAGES[8], width: '38%', left: '80%', duration: '36s', delay: '-32s', startRot: '-12deg', endRot: '12deg', opacity: 0.1 },
...
export const FloatingProofsBackground: React.FC<{ className?: string }> = ({ className = '' }) => {
  return (
    <div className={`fixed inset-y-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] pointer-events-none z-10 overflow-hidden ${className}`}>
      <style>{`
