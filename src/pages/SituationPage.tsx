...
import { ArrowLeft, Target, CheckCircle2, ChevronRight, ChevronDown } from 'lucide-react';
    ...
    <div className="min-h-screen bg-dark-bg text-slate-100 font-sans selection:bg-brand-500 selection:text-white pb-20 pt-10">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-12">
          ...
          <div className="mb-8 bg-brand-900/10 border-l-4 border-brand-500 p-6 md:p-8 rounded-r-2xl shadow-lg">
            <h2 className="text-2xl md:text-3xl text-brand-400 font-bold mb-4">
              {siteContent.affinity.closing} {/* 借用共鳴句起頭，或直接用 positiveFeedback */}
            </h2>
            <p className="text-xl md:text-2xl text-slate-200 font-bold leading-relaxed whitespace-pre-line">
        ...
        <section className="mb-16">
          ...
          >
            <h5 className="text-sm font-bold tracking-widest text-brand-500 mb-6 uppercase flex items-center">
              <Target className="w-5 h-5 mr-3" /> 破口診斷回饋
            </h5>
            ...
            <p className="text-lg md:text-xl text-slate-200 leading-relaxed whitespace-pre-line mb-8 font-medium">
              {painPoint.microDiagnosis}
            </p>
            
            {/* 損失感提醒 */}
            <div className="bg-red-900/10 border-l-4 border-red-500/50 p-6 rounded-r-xl mb-10">
        ...
        <section className="mb-16 bg-slate-900/60 rounded-[2.5rem] p-8 md:p-12 border border-slate-800 text-center shadow-xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-slate-200 leading-tight">
      ...
      </div>{/* End Max Width 4xl */}

      {/* 以下為原來在首頁的長篇論述，接在診斷後方作為防禦性內容 */}
      <div className="mt-32 border-t border-slate-800/80 bg-dark-bg pt-20">
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
             {siteContent.newModel.steps.map((step, idx) => (
                <div key={idx} className="bg-[#0a0f18] p-8 rounded-2xl border border-slate-800 relative flex flex-col sm:flex-row items-start transition-colors">
                  <div className="text-4xl font-black text-slate-800 mr-6 mb-4 sm:mb-0">0{idx+1}</div>
                  <div>
        ...
        <section className="py-24 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white">除了這些，<br className="sm:hidden" />你可能也有的心理掙扎</h2>
          </div>
