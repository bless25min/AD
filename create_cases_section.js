...
const casesSectionCode = 
import { motion } from 'framer-motion'

export function CasesSection() {
  const cases = [
    { title: '醫美術後模擬', src: '/images/醫美術後模擬落地頁.jpg' },
    { title: '遊戲化機制', src: '/images/遊戲化落地頁.jpg' },
    { title: '知識解鎖', src: '/images/知識解鎖落地頁.jpg' }
  ];
...
fs.writeFileSync('../dr-julia/src/features/landing/sections/CasesSection.tsx', casesSectionCode);
console.log('CasesSection created');